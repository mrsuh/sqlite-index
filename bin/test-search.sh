...
sh bin/dump-search.sh data/search/database/search-complex-cardinality-greater-than.sqlite "SELECT rowId, column1, column2 FROM table_test INDEXED BY idx_column1_column2 WHERE column1 >= 500000 AND column2 = 2  LIMIT 5;" data/search/dump/search-complex-cardinality-greater-than-column1.txt
...
sh bin/dump-search.sh data/search/database/search-complex-cardinality-greater-than.sqlite "SELECT rowId, column1, column2 FROM table_test INDEXED BY idx_column2_column1 WHERE column1 >= 500000 AND column2 = 2 LIMIT 5;" data/search/dump/search-complex-cardinality-greater-than-column2.txt
